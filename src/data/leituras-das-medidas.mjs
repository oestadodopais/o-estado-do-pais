 ...
 * do cuidado formal); e o A11, além de trocar uma palavra, muda uma forma: a
 * primeira frase da disparidade salarial passa a ramo `sinal.positivo`, porque
 * «as mulheres ganharam em média menos do que os homens» só é verdade com o
 ...
 * @param {string} maior @param {string} menor @param {string} igual
 */
...
/** @param {any[]} antes @param {string} [dentro] */
...
export const LEITURAS_DAS_MEDIDAS = {
  ...
  'saldo-das-administracoes-publicas-2025': {
    pt: [
      { sinal: {
        positivo: ['Em ', { periodo: 'proprio' }, ' as administrações públicas (o Estado, as regiões autónomas, as autarquias e a segurança social) receberam mais do que gastaram: um excedente de ', { claim: 'proprio' }, PIB_PT],
        negativo: ['Em ', { periodo: 'proprio' }, ' as administrações públicas (o Estado, as regiões autónomas, as autarquias e a segurança social) gastaram mais do que receberam: o saldo foi de ', { claim: 'proprio' }, PIB_PT],
        zero: ['Em ', { periodo: 'proprio' }, ' as administrações públicas (o Estado, as regiões autónomas, as autarquias e a segurança social) gastaram tanto quanto receberam.'],
      } },
    ...
    en: [
      { sinal: {
        positivo: ['In ', { periodo: 'proprio' }, ' general government (the State, the autonomous regions, local authorities and social security) took in more than it spent: a surplus of ', { claim: 'proprio' }, PIB_EN],
        negativo: ['In ', { periodo: 'proprio' }, ' general government (the State, the autonomous regions, local authorities and social security) spent more than it took in: the balance was ', { claim: 'proprio' }, PIB_EN],
        zero: ['In ', { periodo: 'proprio' }, ' general government (the State, the autonomous regions, local authorities and social security) spent exactly what it took in.'],
      } },
  ...
  'posicao-de-investimento-internacional-2025': {
    pt: [
      ...
      { sinal: {
        negativo: [' Negativa quer dizer que o país deve ao exterior mais do que tem lá.', anterior('A responsabilidade líquida perante o exterior encolheu face a', 'A responsabilidade líquida perante o exterior cresceu face a', 'A responsabilidade líquida perante o exterior ficou igual à de')],
    ...
    en: [
      ...
      { sinal: {
        negativo: [' Negative means the country owes abroad more than it owns there.', anterior('The net external liability shrank from', 'The net external liability grew from', 'The net external liability was unchanged from')],
  ...
  'divida-das-empresas-2025': {
    pt: ['É o que as empresas devem em empréstimos e títulos de dívida, fora as financeiras, ', PERCENTAGEM_DO_PIB_PT, PESA, MEDIA_UE, ...TETO_PT(['uma dívida acima de ', { referencia: 'unico' }, ' % do PIB'])],
    en: ['It is what companies owe in loans and debt securities, excluding financial companies, ', PERCENTAGEM_DO_PIB_EN, WEIGHS, EU_AVERAGE, ...TETO_EN(['debt above ', { referencia: 'unico' }, ' % of GDP'])],
  },
  'divida-das-familias-2025': {
    pt: ['É o que as famílias e as instituições sem fim lucrativo ao seu serviço devem em empréstimos e títulos de dívida, ', PERCENTAGEM_DO_PIB_PT, PESA, MEDIA_UE, ...TETO_PT(['uma dívida acima de ', { referencia: 'unico' }, ' % do PIB'])],
  ...
  'ganho-medio-mensal-2024': {
    pt: ['É o que um trabalhador por conta de outrem a tempo completo ganhou por mês, em média, em ', { periodo: 'proprio' }, ', com o que lhe é pago com caráter regular pelas horas normais e extraordinárias, antes de descontos.'],
  ...
  'competencias-digitais-2025': {
    pt: ['É a parte das pessoas com pelo menos competências digitais básicas: saber procurar informação, comunicar, criar conteúdos, proteger-se e resolver problemas no uso da internet e de programas informáticos.', SUBIU, MEDIA_UE],
