...
| K3 | o parágrafo do Portal BASE no Método nas duas edições, com a §1.100 a carimbar `metodo` e `npm run ledger:check` verde | o portão |
...
| K7 | plantas vermelhas e depois verdes: um período escrito à mão no gabarito; o contador a 0 com linhas atrasadas; a §1.100 sem o carimbo | a régua |
