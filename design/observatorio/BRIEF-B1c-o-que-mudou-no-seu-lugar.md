...
*Emenda de 22.09.2026 à tarde (o lugar de direção, depois da primeira passagem do construtor e da leitura a frio): (a) as publicações saem de «O que mudou» na página do país e nas páginas de lugar, porque «Estudos recentes» e «Estudos sobre este lugar», logo acima, são a notícia dos estudos e a lista dos estudos tem-nos todos; a página do país fica com as correções das suas linhas e as mudanças declaradas do projeto, e cada página de lugar com as correções das suas linhas; as publicações continuam no registo; (b) a definição do marcador escreve-se uma vez por página, logo a seguir ao primeiro marcador, como a célula §7.10 do `check:lugar` já exigia, e não «por baixo da lista» como o ponto 4 abaixo dizia; (c) as páginas de região e de distrito não ganham «O que mudou» neste bloco (I133, para o B3); (d) o §0 afirmava duas coisas que o construtor mediu e desmentiu: a página das correções tinha dezasseis linhas datadas, num registo que já existia, e a definição do marcador rendia-se uma vez por página; ficam registadas na §1.120 como erros de medição do lugar de direção.*
