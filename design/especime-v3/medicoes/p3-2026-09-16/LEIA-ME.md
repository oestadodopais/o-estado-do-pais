...
**Os três portões na cabeça `37912148`, cada comando no seu, com o código lido de um ficheiro:**
...
Os códigos ficaram em `n-build.code`, `n-verify.code` e `n-typecheck.code`, e as saídas em `n-build.log`, `n-verify.log` e `n-typecheck.log`, no directório de trabalho da sessão.
...
## 3 · O que se mediu, e com que régua
...
## 5 · O que fica para o lugar de direção
