...
(AQUI/('custo-rp1c.json' if rp1c else 'custo-rp1b.json' if rp1b else 'custo.json')).write_text(json.dumps(resultado,ensure_ascii=False,indent=2)+'\n')
