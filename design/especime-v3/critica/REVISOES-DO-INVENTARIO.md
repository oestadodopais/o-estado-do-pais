...
| areas | 50 | `por ler` | o índice das áreas de governo, as nove páginas de área nas duas edições, o comando e o rodapé da primeira página, e o diff do inventário; a regra mudou a 28.08 de «a área é a de quem publica o número» para «a área é a do ministério que tem a matéria», e a leitura tem de a apanhar nas duas descrições do `<head>` que mudaram, nas seis áreas que entraram e na que saiu |
| areas | 75 | `por ler` | o índice das áreas de governo, as nove páginas de área nas duas edições, o comando e o rodapé da primeira página, e o diff do inventário; a regra mudou a 28.08 de «a área é a de quem publica o número» para «a área é a do ministério que tem a matéria», e a leitura tem de a apanhar nas duas descrições do `<head>` que mudaram, nas seis áreas que entraram e na que saiu. **Segunda passagem a 28.08**, depois da leitura do Codex sobre `bcd1fe5`: 22 linhas passaram a `retirada` (as vinte descrições do `<head>`, o título antigo do índice e a lede), entraram 25 (o título novo, os 21 rótulos de matéria, um por matéria e não um por edição porque são citações da lei, e o rótulo da cabeça nas duas edições, que a medição cega encontrou rendido em vinte sítios e declarado em nenhum), e cada medida passou a render-se na linha-espécime do livro-razão |
