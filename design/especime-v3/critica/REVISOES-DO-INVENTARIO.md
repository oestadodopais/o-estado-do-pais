...
| cabeca | 2 | por ler | o bloco «A cabeça nova como contentor», 01.09.2026, ramo `cabeca-2026-09-01` (construtor Claude Opus 5); as duas linhas são o nome da faixa nas duas edições; a leitura cruzada faz-se antes da fusão |
