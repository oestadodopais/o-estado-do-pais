...
| nomes | 4 | por ler · a leitura a frio deste bloco (F1.4) ainda não correu; as quatro linhas são as duas contagens do índice do livro-razão com o denominador e o estado vazio da busca, nas duas edições | Claude Opus 5, 04.09.2026, bloco F1.4 (os nomes, as datas, o índice) |
