...
| nomes | 6 | por ler · a leitura a frio deste bloco (F1.4) ainda não correu; as linhas são as duas contagens do índice do livro-razão com o denominador, a frase do índice de uma unidade da Carta nas duas edições e o rótulo da busca nas duas | Claude Opus 5, 04.09.2026, bloco F1.4 (os nomes, as datas, o índice) |
