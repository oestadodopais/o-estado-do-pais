...
| conteudo | : União Europeia : acima do valor de referência ( %) | correcao-p1p2 | viva | a mesma régua, com a terceira comparação: a palavra que diz de que lado do valor de referência o número está, e o algarismo entre parênteses, que é o limiar do quadro com o seu motivo declarado (achado 2, 15.09.2026) |
| conteudo | : European Union : above the reference value ( %) | correcao-p1p2 | viva | ver a razão na gémea portuguesa (achado 2, 15.09.2026) |
| navegacao | lido na fonte a · verificado a | correcao-p1p2 | viva | as duas datas que o cartão não escreve, na leitura breve da página do domínio (achado 2, 15.09.2026). A carta dos conteúdos, §1, regra 3, pede três datas por medida, sempre; a primeira passou a ser a do cartão, na linha do valor («em 2025»), e o rótulo de recibo «período de referência» saiu com ela |
| navegacao | read at the source on · verified on | correcao-p1p2 | viva | ver a razão na gémea portuguesa (achado 2, 15.09.2026) |
