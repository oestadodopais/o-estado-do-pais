...
| conteudo | A dívida consolidada das sociedades não financeiras, em percentagem do PIB. | r1 | viva | a frase volta, agora com fonte (bloco R1, 23.09.2026, I142): a resposta do Eurostat ao pedido da própria linha (`tipspd30`, Portugal, em percentagem do PIB) escreve o setor por extenso, «Non-financial corporations debt, consolidated - % of GDP», e passou a ser uma origem da definição em `src/data/figuras.mjs`, com o endereço, a hora de leitura e o sha256 do corpo guardados no motor. Tinha sido retirada pelo achado 6 da leitura do Codex de 14.09.2026, porque nenhuma das fontes então declaradas ligava a sigla «NFC» ao nome por extenso; a sigla e o marcador saem |
...
| conteudo | O número de pessoas dos aos anos sem emprego, em percentagem da população ativa. | i129 | viva | I129, segunda passagem, 22.09.2026: os dois limites (15 e 74) saem da etiqueta `Age class: From 15 to 74 years` do excerto das linhas do desemprego, reescrito pelo gerador do motor. O glossário do Eurostat define a taxa sem idade nenhuma porque a define para qualquer grupo; quem fixa este é o pedido da linha. Os algarismos têm marca de origem própria e saem do texto recolhido. Serve as duas medidas do desemprego, que têm a mesma frase |
| conteudo | The number of unemployed people aged to , as a percentage of the labour force. | i129 | viva | ver a razão na gémea portuguesa (I129, segunda passagem, 22.09.2026) |
| conteudo | A percentagem de pessoas dos aos anos com emprego na população comparável. | i129 | viva | I129, segunda passagem, 22.09.2026: os dois limites (20 e 64) saem da etiqueta `Age class: From 20 to 64 years` do excerto das linhas do emprego. A mesma razão da gémea do desemprego |
| conteudo | The percentage of employed persons aged to in relation to the comparable total population. | i129 | viva | ver a razão na gémea portuguesa (I129, segunda passagem, 22.09.2026) |
...
| conteudo | 2978 afirmações · 330 de 2978 calculadas · 2767 de 2978 linhas de concelhos | cartao | viva | o texto desta linha traz as contagens do livro-razão, e elas subiram de 2975 para 2978 a 23.09.2026, quando o bloco R1 trouxe as três linhas da segunda notificação do INE ao Procedimento dos Défices Excessivos (I147). A linha não mudou de sentido nem de classe: mudou o número que ela conta, e o número é `data-prova` que o portão reconta a cada construção. A entrada anterior dizia «2975 afirmações · 330 de 2975 calculadas · 2767 de 2975 linhas de concelhos», e a de antes do P2 (15.09.2026) «2916 afirmações · 330 de 2916 calculadas · 2767 de 2916 linhas de concelhos» |
| conteudo | 2978 claims · 330 of 2978 calculated · 2767 of 2978 municipality rows | cartao | viva | ver a razão na gémea portuguesa (bloco P2, 15.09.2026, e bloco R1, 23.09.2026) |
...
| conteudo | A percentagem das pessoas dos aos anos, de ambos os sexos, que não tem emprego e não está em estudos nem em formação. | i129 | viva | I129, 22.09.2026: o título que o catálogo do Eurostat dá ao quadro diz «aged 15-24» e a dimensão `age` da resposta ao pedido da linha diz «From 15 to 29 years». Os dois limites saem da etiqueta que o excerto da linha passou a trazer; os algarismos têm marca de origem própria e saem do texto recolhido. A célula K13 do `check:cartao` compara estas palavras com a linha |
| conteudo | The percentage of the population aged to , of both sexes, who is not employed and not involved in further education or training. | i129 | viva | ver a razão na gémea portuguesa (I129, 22.09.2026) |
...
| conteudo | Of the recovery-plan money contracted in the municipality, the university holds more than the council: € against € . Of the sum approved for the municipality, % is overdue against % paid. | b1-peca3 | viva | Leitura aprovada ou texto composto dos estudos e das datas existentes, conferido pela lista fechada do país. |
...
| conteudo | Consolidated debt of non-financial corporations, as a percentage of GDP. | r1 | viva | ver a razão na gémea portuguesa, que voltou a viva no seu lugar no ficheiro (bloco R1, I142, 23.09.2026) |
| conteudo | O fluxo de crédito consolidado às sociedades não financeiras, sem o investimento direto estrangeiro, em percentagem da dívida que elas tinham no período anterior, também sem o investimento direto estrangeiro. | r1 | viva | o setor escreve-se por extenso e a sigla sai (bloco R1, 23.09.2026, I142), provado pela resposta do Eurostat ao pedido da linha da dívida das empresas (`tipspd30`), que escreve «Non-financial corporations»; o resto da frase é o da versão com a sigla, retirada no mesmo bloco, com a mesma razão para o «também» (achado 3 da releitura do Codex de 14.09.2026) |
| conteudo | The consolidated credit flow to non-financial corporations, excluding foreign direct investment, as a percentage of their debt stock in the previous period, also excluding foreign direct investment. | r1 | viva | ver a razão na gémea portuguesa (bloco R1, I142, 23.09.2026) |
