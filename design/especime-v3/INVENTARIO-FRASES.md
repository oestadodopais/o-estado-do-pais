...
| classe | texto | bloco | estado | razão |
| --- | --- | --- | --- | --- |
| conteudo | Quanto devem as administrações públicas, em percentagem do que o país produz num ano? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | How much does general government owe, as a percentage of what the country produces in a year? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
...
| conteudo | Que parte das pessoas ativas está sem trabalho e procura emprego ativamente há pelo menos um ano? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What share of the labour force is out of work and has been actively seeking employment for at least a year? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
...
| conteudo | Portugal está fora de dos valores de referência da Comissão Europeia e dentro de : , , e . | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | Portugal is outside of the reference values of the European Commission and within : , , and . | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | Câmaras com a dívida acima do limite legal | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | Councils with debt above the legal limit | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | câmaras | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | councils | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
...
| conteudo | câmaras cujo índice de dívida publicado é superior ao limite legal | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | councils whose published debt index exceeds the legal limit | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | câmaras cujo índice de dívida publicado não excede o limite legal | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | councils whose published debt index does not exceed the legal limit | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | câmaras cuja fonte não publica um valor numérico do índice de dívida | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | councils whose source publishes no numeric debt index | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | : dentro do valor de referência (acima de − %) | b2-peca1 | viva | A régua do saldo orçamental compara o valor selado com a referência do Pacto; a declaração única e a K9 conferem o número e a direção. |
| conteudo | : fora do valor de referência (acima de %) | b2-peca1 | viva | A régua da despesa líquida compara o valor selado com a referência do Conselho; a declaração única e a K9 conferem o número e a direção. |
| conteudo | : within the reference value (above − %) | b2-peca1 | viva | Ver a razão na gémea portuguesa da régua do saldo orçamental. |
| conteudo | : outside the reference value (above %) | b2-peca1 | viva | Ver a razão na gémea portuguesa da régua da despesa líquida. |
