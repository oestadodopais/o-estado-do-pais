...
| conteudo | Um conjunto limitado de medidas com que a Comissão Europeia apanha os aspetos internos e externos mais relevantes dos desequilíbrios macroeconómicos, cada uma com o seu limiar indicativo. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08. Substitui a frase de contexto do painel, que dizia contra o que a casa confirmou os valores (§9.3 do brief): uma definição cita a Comissão como fonte da definição e não como testemunha desta casa |
| conteudo | The scoreboard of macroeconomic imbalances | lugar | viva | o item 8.4 do F1.10 (08.09.2026): o cabeçalho de cada painel passa a dizer o que ele é, em palavras simples, e o nome oficial com a contagem das medidas desce ao subtítulo. O diretor, a 07.09 à noite: «the European social something … it is not easy to understand what they are» |
| conteudo | A limited set of measures with which the European Commission captures the most relevant internal and external aspects of macroeconomic imbalances, each with its indicative threshold. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08. Substitui a frase de contexto do painel, que dizia contra o que a casa confirmou os valores (§9.3 do brief): uma definição cita a Comissão como fonte da definição e não como testemunha desta casa |
| conteudo | O painel do emprego e das condições sociais | lugar | viva | o item 8.4 do F1.10 (08.09.2026): o cabeçalho de cada painel passa a dizer o que ele é, em palavras simples, e o nome oficial com a contagem das medidas desce ao subtítulo. O diretor, a 07.09 à noite: «the European social something … it is not easy to understand what they are» |
| conteudo | O painel de medidas que apoia o Pilar Europeu dos Direitos Sociais, e com que se avalia o desempenho de emprego e social dos países da União. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «European pillar of social rights · Information on data», https://ec.europa.eu/eurostat/web/european-pillar-of-social-rights/information-data, lido a 2026-09-08. Substitui a frase de contexto do painel, que dizia contra o que a casa confirmou os valores (§9.3 do brief): uma definição cita a Comissão como fonte da definição e não como testemunha desta casa |
| conteudo | The employment and social conditions scoreboard | lugar | viva | o item 8.4 do F1.10 (08.09.2026): o cabeçalho de cada painel passa a dizer o que ele é, em palavras simples, e o nome oficial com a contagem das medidas desce ao subtítulo. O diretor, a 07.09 à noite: «the European social something … it is not easy to understand what they are» |
| conteudo | The scoreboard of key measures that supports the European Pillar of Social Rights, used to assess the employment and social performance of EU countries. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «European pillar of social rights · Information on data», https://ec.europa.eu/eurostat/web/european-pillar-of-social-rights/information-data, lido a 2026-09-08. Substitui a frase de contexto do painel, que dizia contra o que a casa confirmou os valores (§9.3 do brief): uma definição cita a Comissão como fonte da definição e não como testemunha desta casa |
| conteudo | Oito das dezassete medidas principais do Painel Social Europeu. | lugar | viva | o §9.4 do brief do F1.10 (08.09.2026) tirou as duas glosas do Painel Social («as que o livro-razão guarda …»), e a fração ficou: o subtítulo diz «Painel Social Europeu · 8 medidas», e sem esta linha um leitor fica a pensar que o painel tem oito medidas. Tem dezassete principais, declaradas com a origem da Comissão, e o livro-razão guarda oito. É a frase que a régua F16 do check:formas lê no dist com as duas contagens compostas por conta própria |
| conteudo | Eight of the seventeen headline measures of the European Social Scoreboard. | lugar | viva | o §9.4 do brief do F1.10 (08.09.2026) tirou as duas glosas do Painel Social («as que o livro-razão guarda …»), e a fração ficou: o subtítulo diz «Painel Social Europeu · 8 medidas», e sem esta linha um leitor fica a pensar que o painel tem oito medidas. Tem dezassete principais, declaradas com a origem da Comissão, e o livro-razão guarda oito. É a frase que a régua F16 do check:formas lê no dist com as duas contagens compostas por conta própria |
| conteudo | A dívida do setor das administrações públicas, em percentagem do PIB. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | General government sector debt, as a percentage of GDP. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | A diferença entre os ativos financeiros e os passivos que os residentes de uma economia têm relativamente ao resto do mundo, em percentagem do PIB. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição do publicador e citada. Esta era a única das 21 que dizia só o rótulo, porque a página da Comissão sobre o painel publica «net international investment position as percent of GDP» e mais nada e o Eurostat não tem glossário para o conceito; o lugar de direção alargou as origens autorizadas ao compilador nacional a 08.09, e a origem desta é Banco de Portugal, «BPstat · O que é a posição de investimento internacional (PII)?», https://bpstat.bportugal.pt/conteudos/paginas/940, lido a 2026-09-08 |
| conteudo | The difference between the financial assets and liabilities that residents of an economy have vis-à-vis the rest of the world, as a percentage of GDP. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição do publicador e citada. Esta era a única das 21 que dizia só o rótulo, porque a página da Comissão sobre o painel publica «net international investment position as percent of GDP» e mais nada e o Eurostat não tem glossário para o conceito; o lugar de direção alargou as origens autorizadas ao compilador nacional a 08.09, e a origem desta é Banco de Portugal, «BPstat · O que é a posição de investimento internacional (PII)?», https://bpstat.bportugal.pt/conteudos/paginas/940, lido a 2026-09-08 (a edição inglesa da mesma página) |
...
| conteudo | The nominal unit labour cost index, per hour worked, and how much it changed over three years. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | O índice que mede a variação dos preços de transação das casas compradas pelas famílias. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: House price index (HPI)», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:House_price_index_(HPI), lido a 2026-09-08 |
| conteudo | The index that measures the changes in the transaction prices of dwellings purchased by households. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: House price index (HPI)», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:House_price_index_(HPI), lido a 2026-09-08 |
...
| conteudo | A dívida consolidada das sociedades não financeiras, em percentagem do PIB. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | Non-financial corporations’ consolidated debt, as a percentage of GDP. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | A dívida consolidada das famílias, incluindo as instituições sem fim lucrativo ao serviço delas, em percentagem do PIB. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | Household consolidated debt, including non-profit institutions serving households, as a percentage of GDP. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
...
| conteudo | The current account balance as a percentage of GDP, on a three-year backward moving average. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | A percentagem de pessoas ativas, empregadas ou desempregadas, na população comparável, e quanto ela mudou em três anos. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Activity rate», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Activity_rate, lido a 2026-09-08; e Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
| conteudo | The percentage of active persons, employed or unemployed, in the comparable total population, and how much it changed over three years. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Activity rate», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Activity_rate, lido a 2026-09-08; e Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-08 |
...
| conteudo | O número de pessoas sem emprego, em percentagem da população ativa. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Unemployment», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Unemployment_rate, lido a 2026-09-08 |
| conteudo | The number of people unemployed, as a percentage of the labour force. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Unemployment», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Unemployment_rate, lido a 2026-09-08 |
| conteudo | A percentagem de pessoas com emprego na população comparável. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Employment rate», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Employment_rate, lido a 2026-09-08 |
| conteudo | The percentage of employed persons in relation to the comparable total population. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Employment rate», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Employment_rate, lido a 2026-09-08 |
| conteudo | As pessoas sem trabalho que procuram emprego ativamente há pelo menos um ano. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Long-term unemployment», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Long-term_unemployment, lido a 2026-09-08 |
| conteudo | People who are out of work and have been actively seeking employment for at least a year. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Long-term unemployment», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Long-term_unemployment, lido a 2026-09-08 |
| conteudo | A percentagem das pessoas de um grupo de idades que não tem emprego e não está em estudos nem em formação. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Young people neither in employment nor in education and training (NEET)», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Young_people_neither_in_employment_nor_in_education_and_training_(NEET), lido a 2026-09-08 |
| conteudo | The percentage of the population of a given age group who is not employed and not involved in further education or training. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Young people neither in employment nor in education and training (NEET)», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Young_people_neither_in_employment_nor_in_education_and_training_(NEET), lido a 2026-09-08 |
| conteudo | As pessoas dos aos anos que completaram no máximo o ensino básico e não estão em estudos nem em formação. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Early leaver from education and training», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Early_leaver_from_education_and_training, lido a 2026-09-08 |
| conteudo | People aged to who have completed at most lower secondary education and are not involved in further education or training. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Early leaver from education and training», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Early_leaver_from_education_and_training, lido a 2026-09-08 |
| conteudo | A parte da população que está em risco de pobreza, ou em privação material e social grave, ou a viver num agregado com intensidade de trabalho muito baixa; quem está em mais do que uma destas situações conta uma vez só. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: At risk of poverty or social exclusion (AROPE)», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:At_risk_of_poverty_or_social_exclusion_(AROPE), lido a 2026-09-08 |
| conteudo | The share of the total population who are either at risk of poverty, or severely materially and socially deprived, or living in a household with a very low work intensity; people are counted only once even if they are in more than one of these situations. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: At risk of poverty or social exclusion (AROPE)», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:At_risk_of_poverty_or_social_exclusion_(AROPE), lido a 2026-09-08 |
| conteudo | Uma medida da desigualdade na distribuição do rendimento: o rendimento total do quinto da população com mais rendimento a dividir pelo do quinto com menos. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Income quintile share ratio», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Income_quintile_share_ratio, lido a 2026-09-08 |
| conteudo | A measure of the inequality of income distribution: the total income of the fifth of the population with the highest income divided by that of the fifth with the lowest. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Income quintile share ratio», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Income_quintile_share_ratio, lido a 2026-09-08 |
| conteudo | A percentagem da população que vive em agregados onde o custo total da habitação leva mais de % do rendimento disponível. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Housing cost overburden rate», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Housing_cost_overburden_rate, lido a 2026-09-08 |
| conteudo | The percentage of the population living in households where total housing costs take more than % of disposable income. | lugar | viva | o item 8.4 do F1.10 e a segunda metade do 8.14 (08.09.2026), depois de o diretor dizer a 07.09 à noite que não se percebe o que os dois painéis europeus são: cada leitura abre com a definição da medida em palavras simples, tirada da descrição da própria Comissão ou do Eurostat e citada. A origem desta é Eurostat, «Statistics Explained · Glossary: Housing cost overburden rate», https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Housing_cost_overburden_rate, lido a 2026-09-08 |
| navegacao | Números e fontes | lugar | viva | — |
| navegacao | medidas | lugar | viva | — |
| conteudo | As áreas da vida do país com medidas publicadas. | lugar | viva | — |
| conteudo | The areas of the country’s life with published measures. | lugar | viva | — |
...
| navegacao | Mapa dos concelhos do distrito ou da ilha, com uma área por concelho. | lugar | viva | o item 8.17b do F1.10 (08.09.2026): é o `concelhosLabel` que o F1.1e escreveu para o nível da unidade do mapa, e que até aqui só existia depois de um toque na primeira página, onde o guião o põe. A página do concelho rende esse nível DO SERVIDOR, com os concelhos do distrito ou da ilha e o da página marcado, e por isso a cadeia passa a ser um bloco do documento e entra nesta lista. Substitui as duas do mapa da região, que ficaram `retirada` acima |
| navegacao | Map of the municipalities of the district or island, one area per municipality. | lugar | viva | o item 8.17b do F1.10 (08.09.2026): é o `concelhosLabel` que o F1.1e escreveu para o nível da unidade do mapa, e que até aqui só existia depois de um toque na primeira página, onde o guião o põe. A página do concelho rende esse nível DO SERVIDOR, com os concelhos do distrito ou da ilha e o da página marcado, e por isso a cadeia passa a ser um bloco do documento e entra nesta lista. Substitui as duas do mapa da região, que ficaram `retirada` acima |
...
| conteudo | A dívida pública é % do PIB, fora do limiar da Comissão de %; o saldo das administrações públicas é % do PIB, dentro do limiar do Pacto de Estabilidade e Crescimento de − %. | dominio | viva | o item 8.5 do F1.10, segunda passagem (08.09.2026): o fixador do limiar vem do documento que a linha cita, e de mais lado nenhum. Lidos os dois documentos, os dois dizem-no, e «limiar publicado» saiu: a página Statistics Explained do Eurostat que a nota do saldo nomeia atribui o limite de défice ao Pacto de Estabilidade e Crescimento, e o parecer do Conselho das Finanças Públicas que a linha da despesa líquida cita atribui a taxa à trajetória aprovada pelo Conselho da União Europeia. A decisão é a do fecho do F1.10 no dia, na §1.102 |
| conteudo | Government debt is % of GDP, outside the Commission threshold of %; the general government balance is % of GDP, within the Stability and Growth Pact threshold of − %. | dominio | viva | o item 8.5 do F1.10, segunda passagem (08.09.2026): o fixador do limiar vem do documento que a linha cita, e de mais lado nenhum. Lidos os dois documentos, os dois dizem-no, e «limiar publicado» saiu: a página Statistics Explained do Eurostat que a nota do saldo nomeia atribui o limite de défice ao Pacto de Estabilidade e Crescimento, e o parecer do Conselho das Finanças Públicas que a linha da despesa líquida cita atribui a taxa à trajetória aprovada pelo Conselho da União Europeia. A decisão é a do fecho do F1.10 no dia, na §1.102 |
...
| conteudo | limiar do Pacto de Estabilidade e Crescimento − % · dentro do limiar do Pacto de Estabilidade e Crescimento | dominio | viva | o item 8.5 do F1.10, segunda passagem (08.09.2026): o fixador do limiar vem do documento que a linha cita, e de mais lado nenhum. Lidos os dois documentos, os dois dizem-no, e «limiar publicado» saiu: a página Statistics Explained do Eurostat que a nota do saldo nomeia atribui o limite de défice ao Pacto de Estabilidade e Crescimento, e o parecer do Conselho das Finanças Públicas que a linha da despesa líquida cita atribui a taxa à trajetória aprovada pelo Conselho da União Europeia. A decisão é a do fecho do F1.10 no dia, na §1.102 |
| conteudo | limiar recomendado pelo Conselho da UE % · fora do limiar recomendado pelo Conselho da UE | dominio | viva | o item 8.5 do F1.10, segunda passagem (08.09.2026): o fixador do limiar vem do documento que a linha cita, e de mais lado nenhum. Lidos os dois documentos, os dois dizem-no, e «limiar publicado» saiu: a página Statistics Explained do Eurostat que a nota do saldo nomeia atribui o limite de défice ao Pacto de Estabilidade e Crescimento, e o parecer do Conselho das Finanças Públicas que a linha da despesa líquida cita atribui a taxa à trajetória aprovada pelo Conselho da União Europeia. A decisão é a do fecho do F1.10 no dia, na §1.102 |
| conteudo | threshold recommended by the Council of the EU % · outside the threshold recommended by the Council of the EU | dominio | viva | o item 8.5 do F1.10, segunda passagem (08.09.2026): o fixador do limiar vem do documento que a linha cita, e de mais lado nenhum. Lidos os dois documentos, os dois dizem-no, e «limiar publicado» saiu: a página Statistics Explained do Eurostat que a nota do saldo nomeia atribui o limite de défice ao Pacto de Estabilidade e Crescimento, e o parecer do Conselho das Finanças Públicas que a linha da despesa líquida cita atribui a taxa à trajetória aprovada pelo Conselho da União Europeia. A decisão é a do fecho do F1.10 no dia, na §1.102 |
...
| conteudo | Stability and Growth Pact threshold − % · within the Stability and Growth Pact threshold | dominio | viva | o item 8.5 do F1.10, segunda passagem (08.09.2026): o fixador do limiar vem do documento que a linha cita, e de mais lado nenhum. Lidos os dois documentos, os dois dizem-no, e «limiar publicado» saiu: a página Statistics Explained do Eurostat que a nota do saldo nomeia atribui o limite de défice ao Pacto de Estabilidade e Crescimento, e o parecer do Conselho das Finanças Públicas que a linha da despesa líquida cita atribui a taxa à trajetória aprovada pelo Conselho da União Europeia. A decisão é a do fecho do F1.10 no dia, na §1.102 |
| conteudo | O limiar é o limite de défice que os Estados-Membros se comprometeram a respeitar no Pacto de Estabilidade e Crescimento. | dominio | viva | a frase da leitura do item 8.5, na página do domínio (segunda passagem, 08.09.2026). A primeira passagem pô-la na leitura da primeira página, da página europeia e da página do concelho, e esta ficou de fora; as três medidas com limiar desta página têm três fixadores, e é aqui que o saldo e a despesa líquida vivem. As palavras são as do documento que cada linha cita, sem um algarismo: «Under the terms of the EU's Stability and Growth Pact (SGP), Member States pledged to keep their deficits and debt below certain limits», na página Statistics Explained do Eurostat que a nota da linha do saldo nomeia |
| conteudo | The threshold is the deficit limit that Member States pledged to keep to under the Stability and Growth Pact. | dominio | viva | a frase da leitura do item 8.5, na página do domínio (segunda passagem, 08.09.2026). A primeira passagem pô-la na leitura da primeira página, da página europeia e da página do concelho, e esta ficou de fora; as três medidas com limiar desta página têm três fixadores, e é aqui que o saldo e a despesa líquida vivem. As palavras são as do documento que cada linha cita, sem um algarismo |
| conteudo | O limiar é a taxa de crescimento da trajetória da despesa líquida com que Portugal se comprometeu e que o Conselho da União Europeia aprovou. | dominio | viva | a frase da leitura do item 8.5, na página do domínio (segunda passagem, 08.09.2026). A primeira passagem pô-la na leitura da primeira página, da página europeia e da página do concelho, e esta ficou de fora; as três medidas com limiar desta página têm três fixadores, e é aqui que o saldo e a despesa líquida vivem. As palavras são as do documento que cada linha cita, sem um algarismo: «comprometeu-se com uma determinada trajetória de crescimento da despesa líquida, que depois foi aprovada pelo Conselho da UE», na p. 6 do Parecer n.º 02/2026 do Conselho das Finanças Públicas, que é o documento que a linha cita |
| conteudo | The threshold is the growth rate of the net expenditure path that Portugal committed to and that the Council of the European Union approved. | dominio | viva | a frase da leitura do item 8.5, na página do domínio (segunda passagem, 08.09.2026). A primeira passagem pô-la na leitura da primeira página, da página europeia e da página do concelho, e esta ficou de fora; as três medidas com limiar desta página têm três fixadores, e é aqui que o saldo e a despesa líquida vivem. As palavras são as do documento que cada linha cita, sem um algarismo |
...
| classe | texto | bloco | estado | razão |
| --- | --- | --- | --- | --- |
| conteudo | A Direção-Geral das Autarquias Locais não publicou figura para este concelho nesta edição da lista, e o valor ao lado é a marca que ela imprime. | lugar | viva | o que «N.d.» quer dizer, dito por palavras ao pé do cartão que o mostra (decisão 18 da releitura do leitor de primeira vez, 09.09.2026). O leitor de primeira vez encontrou duas respostas incompatíveis para o prazo médio de pagamento de Évora, e são de DUAS LINHAS: o cartão lê a lista da Direção-Geral a 31.12.2025, que imprime «N.d.», e a leitura lê a prestação de contas do próprio concelho no ano de 2025, que publica 137 dias. A frase é a razão que `VALORES_NAO_NUMERICOS` declara em `src/lib/ledger.mjs`, dita na voz da página. Rende-se nas nove páginas de concelho cuja célula a Direção-Geral não determina |
| conteudo | A Direção-Geral das Autarquias Locais não publicou figura para este concelho nesta edição da lista, e o valor ao lado é a marca que ela imprime. Lista anual da Direção-Geral das Autarquias Locais, que publica os dados das contas das câmaras. | lugar | viva | a mesma frase composta com a nota da medida, que é como o bloco se rende no cartão do prazo médio (decisão 18, 09.09.2026) |
| conteudo | A Direção-Geral das Autarquias Locais não publicou figura para este concelho nesta edição da lista, e o valor ao lado é a marca que ela imprime. Série anual da Direção-Geral das Autarquias Locais, que publica os dados das contas das câmaras. Exclui dívidas não orçamentais e exceções legais. | lugar | viva | a mesma frase composta com a nota do índice de dívida de Penedono, que é a outra medida cuja célula a Direção-Geral não determina (decisão 18, 09.09.2026) |
| navegacao | As medidas de cabeça de cada domínio, a busca e o mapa dos concelhos, e as portas para os estudos e para os números com as suas fontes. | lugar | viva | a descrição pública da primeira página diz o que a página mostra hoje (Major 6 da leitura a frio, 09.09.2026): a anterior descrevia os quadros europeus que o item 8.16 tinha levado para `/uniao-europeia` e usava a palavra «indicadores». A L3 passou a ler o `<title>` e as descrições, para que uma descrição desatualizada deixe de ser invisível às réguas |
...
| conteudo | O desempenho das exportações do país face às economias avançadas, e quanto ele mudou em três anos. | lugar | viva | a definição de uma medida do Procedimento, reescrita a 09.09.2026 para o que o excerto da fonte diz (Blocking 1 da leitura a frio). A origem é Comissão Europeia, «Scoreboard · Macroeconomic Imbalance Procedure», https://economy-finance.ec.europa.eu/economic-and-fiscal-governance/macroeconomic-imbalance-procedure/scoreboard_en, lido a 2026-09-09, e o excerto é a linha «export performance against advanced economies (3-year percentage change), with a threshold of -3%.». A página rende a origem ao pé da definição |
| conteudo | O fluxo de crédito consolidado às famílias, incluindo as instituições sem fim lucrativo ao serviço delas, em percentagem da dívida que elas tinham no fim do ano anterior. | lugar | viva | a definição de uma medida do Procedimento, reescrita a 09.09.2026 (Blocking 1): o excerto é «household (incl. NPISH) consolidated credit flow in % of household debt stock in t-1 with a threshold of 14%.», e o nome por extenso das instituições sem fim lucrativo vem do glossário do Eurostat, que é a segunda origem declarada |
| conteudo | O fluxo de crédito consolidado às sociedades não financeiras, sem o investimento direto estrangeiro, em percentagem da dívida que elas tinham no fim do ano anterior. | lugar | viva | a definição de uma medida do Procedimento, reescrita a 09.09.2026 (Blocking 1): o excerto é «NFC (excl. FDI) consolidated credit flow in % of NFC debt stock in t-1 (excl. FDI), with a threshold of 13%.», e o nome por extenso das sociedades não financeiras vem do glossário do Eurostat, que é a segunda origem declarada |
...
| navegacao | Publicado por · | lugar | viva | os dois rótulos da linha da origem de uma definição, na página do domínio, com os nomes da fonte tirados: dizem de que campo é cada pedaço, e o que eles rotulam é o publicador e o documento, que são transcrição registada (Blocking 1 da leitura a frio, 09.09.2026) |
| navegacao | Publicado por · · lido na fonte a | lugar | viva | a mesma linha da origem com o terceiro rótulo, a data em que a casa leu a descrição na fonte (Blocking 1, 09.09.2026) |
| navegacao | Published by · | lugar | viva | ver a razão na gémea portuguesa |
| navegacao | Published by · · read at the source on | lugar | viva | ver a razão na gémea portuguesa |
| navegacao | Sem guião, a lista mostra todos os estudos. | lugar | viva | o que o filtro dos estudos faz sem guião, dito por palavras dentro de um `<noscript>` (Major 7, 09.09.2026): a porta filtrada da página do concelho traz `?concelho=<slug>` e é o guião que esconde as linhas que não casam |
| navegacao | Sem guião, o botão leva à lista inteira dos concelhos, agrupada por distrito e por ilha. | lugar | viva | o que a busca faz sem guião, dito por palavras dentro de um `<noscript>` (Major 7 da leitura a frio, 09.09.2026): o botão submete um `GET` para o índice dos concelhos, e a página estática que chega mostra a lista inteira, porque o filtro é do guião. O leitor sem guião via um botão a prometer uma busca e recebia 308 nomes sem uma palavra a dizer porquê |
| conteudo | The consolidated credit flow to households, including non-profit institutions serving households, as a percentage of their debt stock at the end of the previous year. | lugar | viva | a gémea inglesa da definição reescrita a 09.09.2026 (Blocking 1) |
| conteudo | The consolidated credit flow to non-financial corporations, excluding foreign direct investment, as a percentage of their debt stock at the end of the previous year. | lugar | viva | a gémea inglesa da definição reescrita a 09.09.2026 (Blocking 1) |
| conteudo | The country’s export performance against advanced economies, and how much it changed over three years. | lugar | viva | a gémea inglesa da definição reescrita a 09.09.2026 (Blocking 1) |
| conteudo | The Directorate-General for Local Authorities published no figure for this municipality in this edition of the list, and the value beside it is the mark the list prints. | lugar | viva | ver a razão na gémea portuguesa (decisão 18, 09.09.2026) |
| conteudo | The Directorate-General for Local Authorities published no figure for this municipality in this edition of the list, and the value beside it is the mark the list prints. The annual list of the local-government directorate, which publishes the municipalities’ accounts data. | lugar | viva | ver a razão na gémea portuguesa (decisão 18, 09.09.2026) |
| conteudo | The Directorate-General for Local Authorities published no figure for this municipality in this edition of the list, and the value beside it is the mark the list prints. The annual series of the local-government directorate, which publishes the municipalities’ accounts data. Excludes non-budgetary debt and legal exceptions. | lugar | viva | ver a razão na gémea portuguesa (decisão 18, 09.09.2026) |
| navegacao | The head measures of each domain, the search and the map of the municipalities, and the doors to the studies and to the numbers with their sources. | lugar | viva | ver a razão na gémea portuguesa (Major 6, 09.09.2026) |
| navegacao | Without scripting, the button leads to the full list of municipalities, grouped by district and island. | lugar | viva | ver a razão na gémea portuguesa (Major 7, 09.09.2026) |
| navegacao | Without scripting, the list shows every study. | lugar | viva | ver a razão na gémea portuguesa (Major 7, 09.09.2026) |
| conteudo | · um campo não confirmado contra a fonte, e não uma dúvida sobre o que está publicado | lugar | viva | a definição do marcador `[a verificar]`, ao pé da PRIMEIRA ocorrência de cada página (§7.10 do brief do F1.10, 14.09.2026; a releitura do leitor de primeira vez de 09.09.2026: «`[a verificar]` is not defined beside first occurrences»). É a frase da página do marcador encurtada às duas coisas que ela abre, o que ele é e o que ele não é, e é conteúdo pela mesma razão que a frase da ausência da Direção-Geral: diz o que aquele campo da linha tem, e não o que a casa faz. Rende-se por `<DefinicaoDoMarcador>`, uma vez por página, e a régua do bloco exige que esteja ao pé do primeiro marcador do documento |
| conteudo | · a field not confirmed against the source, not a doubt about what is published | lugar | viva | a gémea inglesa da linha de cima |
| conteudo | [a verificar] · um campo não confirmado contra a fonte, e não uma dúvida sobre o que está publicado | lugar | viva | a mesma definição, no bloco em que o marcador e ela ficam juntos: onde o marcador é o texto todo de um elemento, a régua da voz lê os dois como um bloco só |
| conteudo | [a verificar] · a field not confirmed against the source, not a doubt about what is published | lugar | viva | a gémea inglesa da linha de cima |
