...
| conteudo | Série anual da Direção-Geral das Autarquias Locais, que publica os dados das contas das câmaras. | b1-peca2 | viva | — |
| conteudo | The annual series of the local-government directorate, which publishes the municipalities’ accounts data. | b1-peca2 | viva | — |
