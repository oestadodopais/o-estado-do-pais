...
| conteudo | A dívida consolidada das sociedades não financeiras, em percentagem do PIB. | lugar | retirada | achado 6 da leitura do Codex de 14.09.2026: nenhuma das duas fontes declaradas liga a sigla «NFC» ao nome por extenso (o glossário do Eurostat descreve o setor e nunca escreve a sigla; a página da Comissão escreve a sigla e nunca escreve o nome), e a casa escrevia a expansão como se estivesse provada. A frase nova publica a sigla da fonte e deixa a expansão em `[a verificar]` |
...
| navegacao | as medidas estão em | lugar | viva | achado 12 da leitura cruzada do inventário (Codex, 14.09.2026): é a instrução que manda o leitor para a página de outro domínio, e não uma afirmação sobre o país. É o que esta lista chama navegação: «o que leva a outro sítio» |
| navegacao | the measures are in | lugar | viva | ver a razão na gémea portuguesa (achado 12, 14.09.2026) |
...
| conteudo | A dívida consolidada das NFC, em percentagem do PIB; o nome por extenso da sigla permanece [a verificar] · um campo não confirmado contra a fonte, e não uma dúvida sobre o que está publicado . | lugar | viva | achado 6 da leitura do Codex de 14.09.2026: a definição publica a sigla que a linha da Comissão escreve e deixa a expansão em `[a verificar]`, porque nenhuma das fontes declaradas liga a sigla ao nome por extenso. A legenda do marcador vem colada a ele por ser a primeira ocorrência da página (§7.10) |
| conteudo | NFC consolidated debt, as a percentage of GDP; the full name behind the abbreviation remains [a verificar] (to verify) · a field not confirmed against the source, not a doubt about what is published . | lugar | viva | ver a razão na gémea portuguesa (achado 6, 14.09.2026) |
| conteudo | O fluxo de crédito consolidado às NFC, sem o investimento direto estrangeiro, em percentagem da dívida que elas tinham no período anterior; o nome por extenso da sigla permanece [a verificar] . | lugar | viva | achados 4 e 6 da leitura do Codex de 14.09.2026: o tempo é o do excerto («in t-1») e a expansão da sigla fica em `[a verificar]`. Aqui o marcador vem sem a legenda, porque a primeira ocorrência da página já a levou |
| conteudo | The consolidated credit flow to NFC, excluding foreign direct investment, as a percentage of their debt stock in the previous period; the full name behind the abbreviation remains [a verificar] (to verify) . | lugar | viva | ver a razão na gémea portuguesa (achados 4 e 6, 14.09.2026) |
| conteudo | O fluxo de crédito consolidado às famílias, incluindo as instituições sem fim lucrativo ao serviço delas, em percentagem da dívida que elas tinham no período anterior. | lugar | viva | achado 4 da leitura do Codex de 14.09.2026: o excerto diz «household debt stock in t-1», e «no fim do ano anterior» acrescentava duas palavras que a fonte não escreve |
| conteudo | The consolidated credit flow to households, including non-profit institutions serving households, as a percentage of their debt stock in the previous period. | lugar | viva | ver a razão na gémea portuguesa (achado 4, 14.09.2026) |
| conteudo | A percentagem das pessoas de um grupo de idades e sexo que não tem emprego e não está em estudos nem em formação. | lugar | viva | achado 7 da leitura do Codex de 14.09.2026: o excerto diz «a given age group and sex», e a condição que a fonte põe é dupla |
| conteudo | The percentage of the population of a given age group and sex who is not employed and not involved in further education or training. | lugar | viva | ver a razão na gémea portuguesa (achado 7, 14.09.2026) |
...
| conteudo | O saldo da balança corrente em percentagem do PIB, na média móvel de três anos para trás. | lugar | viva | achado 12 da leitura do Codex de 14.09.2026: o excerto diz «3-year backward moving average», que é uma janela que acaba na observação, e não a média dos três anos antes dela |
| conteudo | A percentagem da população que vive em agregados onde o custo total da habitação, líquido de subsídios à habitação, leva mais de % do rendimento disponível, líquido de subsídios à habitação. | lugar | viva | achado 5 da leitura do Codex de 14.09.2026: o excerto qualifica as duas parcelas, e sem o qualificador muda o que entra no numerador e no denominador. O algarismo do limiar sai do texto recolhido porque tem marca de origem própria |
| conteudo | The percentage of the population living in households where total housing costs, net of housing allowances, take more than % of disposable income, net of housing allowances. | lugar | viva | ver a razão na gémea portuguesa (achado 5, 14.09.2026) |
...
| navegacao | das medidas deste concelho | lugar | viva | ver a razão na primeira das quatro (achado 3, 14.09.2026) |
...
| navegacao | of the head measures of the domains | lugar | viva | ver a razão na gémea portuguesa (achado 3, 14.09.2026) |
| navegacao | of the measures of this domain | lugar | viva | ver a razão na gémea portuguesa (achado 3, 14.09.2026) |
| navegacao | of the measures of this municipality | lugar | viva | ver a razão na gémea portuguesa (achado 3, 14.09.2026) |
