...
| navegacao | incluído em | lugar | viva | a relação entre um domínio e o domínio que o inclui, dita na lista dos domínios (`src/components/DominiosLista.astro`). É navegação pela mesma leitura do achado 12 (Codex, 14.09.2026): manda o leitor para a página de outro domínio, e não é uma afirmação sobre o país. Entrou a 15.09.2026 no lugar de «as medidas estão em», que o diretor não percebeu; a redação é a do §1 do brief do F1.10 |
| navegacao | included in | lugar | viva | ver a razão na gémea portuguesa (15.09.2026) |
