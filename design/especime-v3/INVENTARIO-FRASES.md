...
| navegacao | Fundo | b1-peca2 | retirada | saiu com a peça 2 do B1 (21.09.2026): a página de um lugar passou a ser a linha, o nome, a leitura, os números por tema, os estudos e o que mudou, e com ela saíram as contas do município, a distância desenhada, a leitura breve e o mapa localizador; o índice dos concelhos e o dos distritos passaram a redirecionamentos para a página dos lugares |
...
| conteudo | provisório em | correcao-p1p2 | viva | a linha do valor de um cartão cuja linha traz a bandeira do provisório, com o valor, a unidade e o período tirados: fica a palavra da bandeira e a preposição que liga o valor ao período (achado 2, 15.09.2026) |
| conteudo | provisional in | correcao-p1p2 | viva | ver a razão na gémea portuguesa (achado 2, 15.09.2026) |
...
| conteudo | Dias que a câmara demora a pagar aos fornecedores, pela lista anual da Direção-Geral das Autarquias Locais. | b1-peca2 | viva | — |
| conteudo | Days the council takes to pay its suppliers, from the annual list of the Directorate-General for Local Authorities. | b1-peca2 | viva | — |
| conteudo | O que a câmara deve no fim do ano, pela série anual da Direção-Geral das Autarquias Locais. | b1-peca2 | viva | — |
| conteudo | What the council owes at the end of the year, from the annual series of the Directorate-General for Local Authorities. | b1-peca2 | viva | — |
...
| conteudo | Quanto devem as administrações públicas, em percentagem do PIB? | b2-peca1-correcao-2 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; cada pedaço tem o apoio que a K16 confere em tests/cartao/perguntas-provadas.json. |
...
| conteudo | How much does general government owe, as a percentage of GDP? | b2-peca1-correcao-2 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; cada pedaço tem o apoio que a K16 confere em tests/cartao/perguntas-provadas.json. |
| conteudo | Qual é a diferença entre os ativos financeiros e os passivos dos residentes face ao resto do mundo, em percentagem do PIB? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What is the difference between residents’ financial assets and liabilities relative to the rest of the world, as a percentage of GDP? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Quanto mudou em três anos o índice nominal do custo unitário do trabalho, por hora trabalhada? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | How much has the nominal unit labour cost index, per hour worked, changed over three years? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Quanto mudaram os preços de transação das casas compradas pelas famílias? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | How much have the transaction prices of homes purchased by households changed? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Quanto mudou em três anos o desempenho das exportações do país face às economias avançadas? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | How much has the country’s export performance against advanced economies changed over three years? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Quanto devem as sociedades não financeiras, em dívida consolidada e em percentagem do PIB? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | How much do non-financial corporations owe in consolidated debt, as a percentage of GDP? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Quanto devem as famílias e as instituições sem fim lucrativo ao seu serviço, em dívida consolidada e em percentagem do PIB? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | How much do households and non-profit institutions serving them owe in consolidated debt, as a percentage of GDP? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Quanto representa o fluxo de crédito consolidado às sociedades não financeiras na dívida que tinham no período anterior, excluindo o investimento direto estrangeiro das duas parcelas? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What percentage of non-financial corporations’ debt in the previous period does their consolidated credit flow represent, excluding foreign direct investment from both amounts? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Que percentagem da dívida das famílias e das instituições sem fim lucrativo ao seu serviço no período anterior representa o fluxo de crédito consolidado que recebem? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What percentage of the debt of households and non-profit institutions serving them in the previous period does their consolidated credit flow represent? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Qual é o saldo da balança corrente em percentagem do PIB, na média móvel de três anos para trás? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What is the current account balance as a percentage of GDP, on a three-year backward moving average? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Quanto mudou em três anos a percentagem de pessoas ativas, empregadas ou desempregadas, na população comparável? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | How much has the percentage of active people, employed or unemployed, in the comparable total population changed over three years? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Que parte da população ativa dos aos anos está sem emprego? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What share of the labour force aged to is unemployed? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
...
| conteudo | Que parte da população ativa dos aos anos está sem trabalho e procura emprego ativamente há pelo menos um ano? | b2-peca1-correcao-2 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; cada pedaço tem o apoio que a K16 confere em tests/cartao/perguntas-provadas.json. |
...
| conteudo | What share of the labour force aged to is out of work and has been actively seeking employment for at least a year? | b2-peca1-correcao-2 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; cada pedaço tem o apoio que a K16 confere em tests/cartao/perguntas-provadas.json. |
...
| conteudo | Que parte da população está em risco de pobreza, em privação material e social grave ou num agregado com intensidade de trabalho muito baixa, contando cada pessoa uma única vez? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What share of the population is at risk of poverty, severely materially and socially deprived or living in a household with very low work intensity, counting each person only once? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
...
| conteudo | Que parte dos inquilinos a preço de mercado vive em agregados onde o custo total da habitação, líquido de subsídios à habitação, leva mais de % do rendimento disponível, também líquido de subsídios à habitação? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | What share of tenants at market rent are in households where total housing costs, net of housing allowances, take more than % of disposable income, also net of housing allowances? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
...
| conteudo | What share of people, across all tenure statuses, are in households where total housing costs, net of housing allowances, take more than % of disposable income, also net of housing allowances? | b2-peca1 | viva | A pergunta do leitor, declarada em figuras.mjs e conferida pela K6; as origens mantêm-se e a K13 confere as idades onde a linha as fixa. |
| conteudo | Do dinheiro do plano de recuperação contratado no concelho, a universidade tem mais do que a câmara: euros contra euros . Da soma aprovada para o concelho, % está vencida contra % paga. | b2-peca1 | viva | A unidade monetária vem da linha, pela tabela de unidades; a sinopse inteira é conferida pela lista fechada da leitura. |
| conteudo | Of the recovery-plan money contracted in the municipality, the university holds more than the council: euros against euros . Of the sum approved for the municipality, % is overdue against % paid. | b2-peca1 | viva | A unidade monetária vem da linha, pela tabela de unidades; a sinopse inteira é conferida pela lista fechada da leitura. |
| conteudo | fora do valor de referência | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | dentro do valor de referência | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | dentro dos valores de referência | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | outside the reference value | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | within the reference value | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
| conteudo | within the reference values | b2-peca1 | viva | O estado e a direção são conferidos pela K15; as contagens e as frases do país e das câmaras são conferidas pela V1, pela V2 e pelo portão de HTML. |
...
| conteudo | : dentro do valor de referência (acima de − %) | b2-peca1-correcao-2 | viva | A forma de uma referência da Comissão com chão negativo, rendida pelo desempenho das exportações (acima de −3 %); a do saldo passou a nomear o Pacto (achado 16). A K15 confere a palavra, a direção e a cor. |
| conteudo | : dentro do valor de referência do Pacto (acima de − %) | b2-peca1-correcao-2 | viva | A V1, V2 e K15 conferem a forma e a origem. |
| conteudo | : fora do valor de referência do Conselho da UE (acima de %) | b2-peca1-correcao-2 | viva | A V1, V2 e K15 conferem a forma e a origem. |
| conteudo | : within the reference value (above − %) | b2-peca1-correcao-2 | viva | Ver a razão na gémea portuguesa (a forma da Comissão com chão negativo). |
| conteudo | : within the reference value of the Pact (above − %) | b2-peca1-correcao-2 | viva | A V1, V2 e K15 conferem a forma e a origem. |
| conteudo | : outside the reference value of the Council of the EU (above %) | b2-peca1-correcao-2 | viva | A V1, V2 e K15 conferem a forma e a origem. |
| conteudo | : provisório | b2-peca1 | viva | A régua da disparidade salarial entre sexos mostra o período anterior selado; o estado provisório pertence à linha e mantém a marca própria. |
| conteudo | : provisional | b2-peca1 | viva | Ver a razão na gémea portuguesa do estado da disparidade salarial entre sexos. |
...
| conteudo | 3000 afirmações · 330 de 3000 calculadas · 2767 de 3000 linhas de concelhos | b2-peca1 | viva | Os contadores provados do índice do livro-razão incluem as linhas seladas do B2; cada número vem de data-prova e é recontado pelo portão de HTML. |
| conteudo | 3000 claims · 330 of 3000 calculated · 2767 of 3000 municipality rows | b2-peca1 | viva | Ver a razão na gémea portuguesa dos contadores do índice do livro-razão. |
| conteudo | dentro do valor de referência do Pacto | b2-peca1-correcao-2 | viva | O período, o dono ou a unidade vêm da declaração conferida. |
| conteudo | fora do valor de referência do Conselho da UE | b2-peca1-correcao-2 | viva | O período, o dono ou a unidade vêm da declaração conferida. |
| conteudo | within the reference value of the Pact | b2-peca1-correcao-2 | viva | O período, o dono ou a unidade vêm da declaração conferida. |
| conteudo | outside the reference value of the Council of the EU | b2-peca1-correcao-2 | viva | O período, o dono ou a unidade vêm da declaração conferida. |
...
| classe | texto | bloco | estado | razão |
| --- | --- | --- | --- | --- |
| conteudo | Em as administrações públicas (o Estado, as regiões autónomas, as autarquias e a segurança social) receberam mais do que gastaram: um excedente de % do PIB, o valor de tudo o que o país produz num ano. O saldo subiu face a . O Pacto de Estabilidade e Crescimento não deixa o défice passar de % do PIB: Portugal cumpre. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | Entre as pessoas que vivem em casa arrendada a preço de mercado, é a parte cujo agregado gasta mais de % do rendimento disponível com a habitação. O rendimento disponível é o que o agregado recebe, do trabalho, de investimentos e de prestações sociais, depois de pagos os impostos e as contribuições sociais; os apoios à habitação descontam-se do rendimento e do que se gasta com a habitação. Desceu face a . Está acima da média da União Europeia. | l1-correcao | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1), mudada na passagem de correção de 26.09.2026, depois da leitura a frio do Codex: ganhou a frase que diz o que é o rendimento disponível (o acerto A23, pelo glossário do Eurostat do rendimento disponível e pelo da sobrecarga). As palavras são do lugar de direção com os acertos conferidos por `acertos-l1.py`; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e a K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`). |
| conteudo | No total de todos os regimes de ocupação (casa própria com ou sem crédito, arrendada a preço de mercado ou a renda reduzida ou gratuita), é a parte das pessoas cujo agregado gasta mais de % do rendimento disponível com a habitação. O rendimento disponível é o que o agregado recebe, do trabalho, de investimentos e de prestações sociais, depois de pagos os impostos e as contribuições sociais; os apoios à habitação descontam-se do rendimento e do que se gasta com a habitação. Desceu face a . Este total mistura situações muito diferentes, e a Comissão Europeia diz que deve ler-se com a estrutura por regime de ocupação. | l1-correcao | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1), mudada na passagem de correção de 26.09.2026, depois da leitura a frio do Codex: ganhou a frase que diz o que é o rendimento disponível (o acerto A24, pelas mesmas origens do A23). As palavras são do lugar de direção com os acertos conferidos por `acertos-l1.py`; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e a K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`). |
| conteudo | Os % da população com mais rendimento recebem, no total, vezes o que recebem os % com menos rendimento. A diferença encolheu face a . É maior do que na média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | Por cada hora de trabalho, as mulheres ganharam em média menos do que os homens, em , nas empresas com ou mais trabalhadores: a diferença, em percentagem do ganho dos homens, foi de % provisório . A diferença encolheu face a . | l1-correcao | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1), mudada na passagem de correção de 26.09.2026, depois da leitura a frio do Codex: a frase reescrita pelo lugar de direção no seu ficheiro, para que o valor feche a oração e «provisório» feche com ele, com o acerto A11 de sempre. As palavras são do lugar de direção com os acertos conferidos por `acertos-l1.py`; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e a K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`). |
...
| conteudo | É a parte da população que está em pelo menos uma de três situações: rendimento abaixo de % do rendimento mediano do país, privação material e social grave, ou viver num agregado onde quase ninguém trabalha; cada pessoa conta uma só vez. O rendimento mediano é o do meio: metade da população tem mais e metade tem menos. Desceu face a . Está abaixo da média da União Europeia. | l1-correcao | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1), mudada na passagem de correção de 26.09.2026, depois da leitura a frio do Codex: ganhou a frase que diz o que é o rendimento mediano (o acerto A21, pelo glossário do Eurostat da mediana). As palavras são do lugar de direção com os acertos conferidos por `acertos-l1.py`; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e a K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`). |
| conteudo | É a parte das crianças com menos de anos que está numa creche ou noutro cuidado formal: um programa planeado por entidades públicas ou privadas reconhecidas, e não o cuidado dado pelos avós, por outros familiares, por amigos ou vizinhos, ou por uma ama profissional. Desceu face a . Está acima da média da União Europeia. | l1-correcao | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1), mudada na passagem de correção de 26.09.2026, depois da leitura a frio do Codex: diz o que é o cuidado formal e o que fica fora dele (o acerto A22, pela página do Eurostat que o bloco já tinha alojado). As palavras são do lugar de direção com os acertos conferidos por `acertos-l1.py`; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e a K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`). |
| conteudo | É a parte das pessoas com pelo menos competências digitais básicas: saber procurar informação, comunicar, criar conteúdos, proteger-se e resolver problemas no uso da internet e de programas informáticos. Subiu face a . Está abaixo da média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | É a parte das pessoas dos aos anos que não foi além do ensino básico e já não estuda nem está em formação. Desceu face a . Está abaixo da média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | É a parte das pessoas dos aos anos que tem emprego. Subiu face a . Está acima da média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | É a parte das pessoas que diz ter precisado de um médico e não o ter tido, por ser caro, por a espera ser longa ou por ficar longe. Ficou igual a . Está acima da média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | É a parte das pessoas que, num inquérito europeu, considera a independência dos tribunais e dos juízes do seu país muito boa ou razoavelmente boa. Subiu face a . Está acima da média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | É a área de habitação nova licenciada num ano, em metros quadrados por cada habitantes: quanto mais alta, mais construção de casas foi autorizada. Subiu face a . Está acima da média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
| conteudo | É o que as empresas, o Estado, as famílias e as instituições sem fim lucrativo que produzem no país compraram num ano, descontado o que venderam, em bens que duram mais de um ano, como edifícios, máquinas e programas informáticos, em percentagem do PIB, o valor de tudo o que o país produz num ano. Subiu face a . Está abaixo da média da União Europeia. | l1-correcao | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1), mudada na passagem de correção de 26.09.2026, depois da leitura a frio do Codex: diz quem são os produtores residentes (o acerto A25, pelo glossário do Eurostat da unidade institucional residente). As palavras são do lugar de direção com os acertos conferidos por `acertos-l1.py`; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e a K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`). |
| conteudo | É o que se gastou no país em investigação e desenvolvimento num ano, pelas empresas, pelo Estado, pelo ensino superior e pelas instituições sem fins lucrativos, em percentagem do PIB, o valor de tudo o que o país produz num ano. Subiu face a . Está abaixo da média da União Europeia. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
...
| conteudo | É o valor de tudo o que o país produziu no ano, por habitante, descontada a subida dos preços. Subiu face a . Está abaixo da média da União Europeia. | l1-correcao | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1), mudada na passagem de correção de 26.09.2026, depois da leitura a frio do Codex: «descontada a subida dos preços» no lugar de «em termos reais» (o acerto A18, pela ficha de metadados nama10 e pelo glossário da inflação). As palavras são do lugar de direção com os acertos conferidos por `acertos-l1.py`; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e a K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`). |
| conteudo | É quanto cresceu num ano a despesa pública líquida: a que não conta os juros da dívida, a despesa financiada por fundos europeus nem a que sobe e desce com o desemprego, apurada pelo Conselho das Finanças Públicas. Cresceu menos do que em . Portugal comprometeu-se, num compromisso endossado pelo Conselho da União Europeia, a não a deixar crescer mais de % em : cresceu mais do que isso. | l1 | viva | A leitura do que o número significa, por baixo do número de um cartão nacional (bloco L1, 24.09.2026, I150). As palavras são do lugar de direção, declaradas em `src/data/leituras-das-medidas.mjs` com os acertos A1 a A15 da auditoria das origens; os valores, os períodos, as referências e as contagens saem da recolha como origens conferidas, e os ramos são os que os valores selados mandam. A K17 do `check:cartao` confere o texto, os ramos e a auditoria das origens (`tests/cartao/leituras-provadas.json`); um ramo que mude com um valor novo rende outra frase, que entra aqui quando se render. |
...
| conteudo | Across all tenure statuses (owned with or without a mortgage, rented at market price or at a reduced rent or free), it is the share of people whose household spends more than % of its disposable income on housing. Disposable income is what the household receives, from work, investment and social benefits, after the taxes and social contributions it pays; housing allowances are deducted from both the income and the housing costs. Down from . This total mixes very different situations, and the European Commission says it should be read together with the tenure structure. | l1-correcao | viva | Ver a razão na gémea portuguesa (bloco L1, passagem de correção de 26.09.2026). |
| conteudo | Among people living in a home rented at market price, it is the share whose household spends more than % of its disposable income on housing. Disposable income is what the household receives, from work, investment and social benefits, after the taxes and social contributions it pays; housing allowances are deducted from both the income and the housing costs. Down from . Above the European Union average. | l1-correcao | viva | Ver a razão na gémea portuguesa (bloco L1, passagem de correção de 26.09.2026). |
| conteudo | In general government (the State, the autonomous regions, local authorities and social security) took in more than it spent: a surplus of % of GDP, the value of everything the country produces in a year. The balance rose from . The Stability and Growth Pact does not allow the deficit to exceed % of GDP: Portugal complies. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | It is how much net public expenditure grew in a year: the expenditure that leaves out interest on the debt, spending financed by European funds and the spending that rises and falls with unemployment, as computed by the Public Finance Council. It grew less than in . Portugal committed, in a commitment endorsed by the Council of the European Union, not to let it grow by more than % in : it grew more than that. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | It is the floor area of new housing permitted in a year, in square metres per inhabitants: the higher it is, the more housing construction was authorised. Up from . Above the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
...
| conteudo | It is the share of children under who are in a nursery or other formal childcare: a programme planned through public organisations or recognised private bodies, and not care given by grandparents, other relatives, friends or neighbours, or a professional child-minder. Down from . Above the European Union average. | l1-correcao | viva | Ver a razão na gémea portuguesa (bloco L1, passagem de correção de 26.09.2026). |
| conteudo | It is the share of people aged to who are employed. Up from . Above the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | It is the share of people aged to who went no further than lower secondary education and are no longer studying or in training. Down from . Below the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | It is the share of people who say they needed medical care and did not get it, because it was too expensive, the wait too long or too far away. Unchanged from . Above the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | It is the share of people who, in a European survey, rate the independence of their country’s courts and judges as very good or fairly good. Up from . Above the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | It is the share of people with at least basic digital skills: knowing how to find information, communicate, create content, stay safe and solve problems when using the internet or software. Up from . Below the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | It is the share of the population in at least one of three situations: income below % of the country’s median income, severe material and social deprivation, or living in a household where almost no one works; each person counts only once. The median income is the one in the middle: half the population has more and half has less. Down from . Below the European Union average. | l1-correcao | viva | Ver a razão na gémea portuguesa (bloco L1, passagem de correção de 26.09.2026). |
| conteudo | It is the value of everything the country produced in the year, per inhabitant, excluding the rise in prices. Up from . Below the European Union average. | l1-correcao | viva | Ver a razão na gémea portuguesa (bloco L1, passagem de correção de 26.09.2026). |
...
| conteudo | It is what companies, the State, households and non-profit institutions that produce in the country acquired in a year, less what they disposed of, in assets that last more than a year, such as buildings, machinery and software, as a percentage of GDP, the value of everything the country produces in a year. Up from . Below the European Union average. | l1-correcao | viva | Ver a razão na gémea portuguesa (bloco L1, passagem de correção de 26.09.2026). |
| conteudo | It is what was spent in the country on research and development in a year, by companies, the State, higher education and non-profit institutions, as a percentage of GDP, the value of everything the country produces in a year. Up from . Below the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
| conteudo | Per hour worked, women earned on average less than men, in , in enterprises with or more employees: the gap, as a percentage of men’s earnings, was % provisional . The gap narrowed from . | l1-correcao | viva | Ver a razão na gémea portuguesa (bloco L1, passagem de correção de 26.09.2026). |
| conteudo | The % of the population with the highest income receive, in total, times what the % with the lowest income receive. The gap narrowed from . It is wider than the European Union average. | l1 | viva | Ver a razão na gémea portuguesa (bloco L1, 24.09.2026, I150). |
...
| classe | texto | bloco | estado | razão |
| --- | --- | --- | --- | --- |
| conteudo | Em , por cada mil pessoas em idade ativa, recebiam o rendimento social de inserção, um apoio da Segurança Social para satisfazer necessidades essenciais e favorecer a inserção laboral, social e comunitária. Menos do que em . | rp1 | viva | Pergunta ou leitura das novas medidas seladas; as palavras têm origem na K16 ou na K17 e os valores continuam a ser lidos das linhas. |
| conteudo | Em o valor das pensões pagas pela Segurança Social foi, em média, de euros por pensionista no ano inteiro, contando as pensões pagas de velhice, de invalidez e de sobrevivência. Subiu face a . | rp1 | viva | Pergunta ou leitura das novas medidas seladas; as palavras têm origem na K16 ou na K17 e os valores continuam a ser lidos das linhas. |
| conteudo | Na média dos doze meses até , os preços no consumidor sem a habitação variaram % face aos doze meses anteriores. O valor de agosto serve de referência para a atualização das rendas no ano seguinte. A variação é maior do que a do mês anterior. | rp1 | viva | Pergunta ou leitura das novas medidas seladas; as palavras têm origem na K16 ou na K17 e os valores continuam a ser lidos das linhas. |
...
| conteudo | In , for every thousand people of working age, received social insertion income, a Social Security benefit to meet essential needs and support integration into employment, society and the community. Fewer than in . | rp1 | viva | Pergunta ou leitura das novas medidas seladas; as palavras têm origem na K16 ou na K17 e os valores continuam a ser lidos das linhas. |
| conteudo | In the amount of pensions paid by Social Security was, on average, euros per pensioner over the whole year, counting old-age, invalidity and survivors’ pensions paid. Up from . | rp1 | viva | Pergunta ou leitura das novas medidas seladas; as palavras têm origem na K16 ou na K17 e os valores continuam a ser lidos das linhas. |
| conteudo | On average over the twelve months to , consumer prices excluding housing changed by % compared with the previous twelve months. The August value is the reference figure for updating rents in the following year. The change is larger than the previous month’s. | rp1 | viva | Pergunta ou leitura das novas medidas seladas; as palavras têm origem na K16 ou na K17 e os valores continuam a ser lidos das linhas. |
